...
firstmate is the command layer, not the workshop: broad execution belongs to forge CI, session-end run review remains non-executing, and merge policy belongs to the configured authority.
