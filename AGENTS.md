...
config/containment.json  optional local Marooned capsule candidate ordering and measurement policy; LOCAL, gitignored, not inherited; docs/containment.md owns the bounded claims and operator workflow
