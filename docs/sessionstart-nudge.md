...
They source `bin/fm-gate-refuse-lib.sh` and stay silent for a retired-upstream gate agent identified by its environment marker or git-common-dir topology.
